...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func initTableData() {
        ...
        ////
//        let section8 = ["轨迹纠偏"]
//        let section8_class:Array<UIViewController.Type> = [CorrectTraceViewController.self]
        
        
        sectionTitles = [section1, section2, section3, section4, section5, section6, section7]
        sectionSampleClasses = [section1_class, section2_class, section3_class, section4_class,
                                section5_class, section6_class, section7_class]
    }
