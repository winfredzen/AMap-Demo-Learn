...
class ScreenShotViewController: UIViewController, MAMapViewDelegate, UIGestureRecognizerDelegate {
    ...
    func initToolbar() {
        ...
        let captureItem = UIBarButtonItem.init(title: "Capture", style: UIBarButtonItemStyle.plain, target: self, action: #selector(self.captureAction))
    ...
    @objc func startAction() {
        ...
        self.navigationItem.rightBarButtonItem?.title = started ? "Stop" : "Start"
