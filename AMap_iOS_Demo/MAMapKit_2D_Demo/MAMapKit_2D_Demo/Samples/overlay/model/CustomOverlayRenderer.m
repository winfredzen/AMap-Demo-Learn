...
- (void)drawMapRect:(MAMapRect)mapRect zoomScale:(MAZoomScale)zoomScale inContext:(CGContextRef)context
{
    ...
    [legendString drawAtPoint:CGPointMake(width * 0.3, width * 0.45) withAttributes:@{NSFontAttributeName : [UIFont systemFontOfSize:20.0 / zoomScale], NSForegroundColorAttributeName:[UIColor blackColor]}];
