...
- (MAOverlayRenderer *)mapView:(MAMapView *)mapView rendererForOverlay:(id <MAOverlay>)overlay
{
    ...
    {
        MAMultiColoredPolylineRenderer *polylineView = [[MAMultiColoredPolylineRenderer alloc] initWithMultiPolyline:overlay];
        
        polylineView.lineWidth   = 6.f;
        
        polylineView.strokeColors = self.debugColors;
